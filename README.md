...
**App icons:** generated by `tools/build-icons.py` — re-run it if the brand mark changes:

```
python tools/build-icons.py
```

It writes `images/icon-192.png`, `icon-512.png`, `icon-maskable-512.png` (full-bleed for
Android adaptive icons), `apple-touch-icon.png` (iOS home screen) and `favicon-32.png`.
